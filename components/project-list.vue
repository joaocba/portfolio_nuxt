...
const { error, pending, data } = await useFetch("https://api.github.com/users/joaocba/repos");

// Filter data by description not empty and sort (descending order: b - a) by stars
